...
function listar() {
    ...
    fetch("http://localhost:8080/CadeEstacionamento", {method: "GET", headers: myHeaders})
...
function alterar(id) {
    ...
    fetch("http://localhost:8080/CadeEstacionamento/"+idatual, {method: "GET", headers: myHeaders})
    .then(response => response.json())
    .then(data => {
...
function excluirSim() {
    ...
    fetch("http://localhost:8080/CadeEstacionamento/" + idatual, {method: "DELETE", headers: myHeaders})
    .then(response => {
...
function salvar() {
    ...
    var metodo;
    if (idatual==0) {
        url = "http://localhost:8080/CadeEstacionamento";
        metodo = "POST";
    } else {
        url = "http://localhost:8080/CadeEstacionamento/" + idatual;
        metodo = "PUT";
    }
